...
public class UMarkusParamForm extends VerticalLayout {
	...
	private ComboBox ibc = new ComboBox("Initial boundary condition", Arrays.asList("Zero", "Debye-Huckel Dipole", "Debye-Huckel Total"));
	...
	private class SubmitListener implements Button.ClickListener{
		...
		private UMarkusParamForm form = null;
		public SubmitListener(UMarkusParamForm paramform){
			form = paramform;
		}
		@Override
