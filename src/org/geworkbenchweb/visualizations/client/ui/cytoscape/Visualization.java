...
public class Visualization extends JavaScriptObject{
	...
	private static final native JavaScriptObject wrap(ReadyCallback c)/*-{
		var f = function(){
			c.@org.geworkbenchweb.visualizations.client.ui.cytoscape.ReadyCallback::invoke()();
		};
		return f;
	}-*/;
	...
	private static final native JavaScriptObject wrap(EventCallback c)/*-{
		var f = function(e){
			c.@org.geworkbenchweb.visualizations.client.ui.cytoscape.EventCallback::invoke(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
		};
		return f;
	}-*/;
	...
	private static final native JavaScriptObject wrap(FilterCallback c)/*-{
		var f = function(e){
			return c.@org.geworkbenchweb.visualizations.client.ui.cytoscape.FilterCallback::invoke(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
		};
		return f;
	}-*/;
	...
	public final native void addContextMenuItem(String lbl, String gr, EventCallback callback)/*-{
		var fn = @org.geworkbenchweb.visualizations.client.ui.cytoscape.Visualization::wrap(Lorg/geworkbenchweb/visualizations/client/ui/cytoscape/EventCallback;)(callback);
	...
	public final native void filter(String gr, FilterCallback callback, boolean updateVisualMappers)/*-{
		var fn = @org.geworkbenchweb.visualizations.client.ui.cytoscape.Visualization::wrap(Lorg/geworkbenchweb/visualizations/client/ui/cytoscape/FilterCallback;)(callback);
	...
	public final native void ready(ReadyCallback callback)/*-{
		var fn = @org.geworkbenchweb.visualizations.client.ui.cytoscape.Visualization::wrap(Lorg/geworkbenchweb/visualizations/client/ui/cytoscape/ReadyCallback;)(callback);
		this.ready(fn);
	}-*/;
