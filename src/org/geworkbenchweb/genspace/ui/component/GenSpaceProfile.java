...
public class GenSpaceProfile extends AbstractGenspaceTab implements GenSpaceTab, ClickListener{
	 ...
	 * visual editor.
	 */
	public GenSpaceProfile(final GenSpaceLogin login) {
		super(login);
		buildMainLayout();
		loggedIn();
	...
	private GridLayout buildMainLayout() {
		...
		mainLayout.addComponent(lname, 1, 1);
		...
		mainLayout.addComponent(labaff, 1, 2);
		...
		mainLayout.addComponent(email, 1, 3);
		...
		mainLayout.addComponent(phone, 1, 4);
		...
		mainLayout.addComponent(addr1, 1, 5);
		...
		mainLayout.addComponent(addr2, 1, 6);
		...
		mainLayout.addComponent(city, 1, 7);
		...
		mainLayout.addComponent(state, 1, 8);
		...
		mainLayout.addComponent(zipcode, 1, 9);
	...
	private void applyProfileChanges() {
		...
		/*GenSpaceServerFactory.getUser().setFirstName((String) fname.getValue());
		GenSpaceServerFactory.getUser().setLastName((String) lname.getValue());
		GenSpaceServerFactory.getUser().setLabAffiliation((String) labaff.getValue());
		GenSpaceServerFactory.getUser().setEmail((String) email.getValue());
		GenSpaceServerFactory.getUser().setPhone((String) phone.getValue());
		GenSpaceServerFactory.getUser().setAddr1((String) addr1.getValue());
		GenSpaceServerFactory.getUser().setAddr2((String) addr2.getValue());
		GenSpaceServerFactory.getUser().setCity((String) city.getValue());
		GenSpaceServerFactory.getUser().setState((String) state.getValue());
		GenSpaceServerFactory.getUser().setZipcode((String) zipcode.getValue());*/
