...
public class ProteinStructureUI extends DataTypeMenuPage {
	...
	public ProteinStructureUI(Long dataSetId) {
		super("List of analysis and visualization modules that can process macromolecular structure data.",
				"Protein Structure Data", org.geworkbenchweb.pojos.PdbFileInfo.class, dataSetId);
	}
}
